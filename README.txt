...
The database will be completely empty. Do not relocate the database outside of the folder it is created in. Doing this will eliminate all your data and the application will create a new databse folder where the old one was. 
