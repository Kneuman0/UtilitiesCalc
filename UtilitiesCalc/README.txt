...
README
Fully functioning stand alone application (once exported to a runnable .jar file). Manages the utility bills for tenants in an residence. Handles sublets who did not stay for a full month, landlords who pay no utilities and full time standard tenants. Uses relational database to store and track payments for each tenant from month to month. Allows tenants to export a receipt detailing each tenants bills for the month and their yearly contributions.  
